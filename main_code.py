import requests, re, os, json, base64, uuid, random
...
def banner():
    ...
    print(Colorate.Horizontal(Colors.white_to_blue,"                © Bản Quyền Nguyễn Hoàng Kha !!!!"))
    thanhngang(65)
    print(f'''{thanh}{luc}Admin{trang}: {vang}Nguyễn Hoàng Kha
{thanh}{luc}Zalo{trang}: {do}0868 521 296
{thanh}{luc}Bạn Đang Sử Dụng Tool{trang}: {vang}Tương Tác Chéo Facebook''')
    thanhngang(65)
...
print(f'{thanh}{luc}Xu Hiện Tại{trang}: {vang}{str(format(int(checktoken['xu']),","))}')
